...
from data_ingestion.app_weather.kafka_weather import consumer_weather, produce_weather
...
def main():
    ...
    try:
        ...
        p1 = Process(target=produce_weather, args=(params, logger_))
        
        # consume a message and store it in a mongodb
        p2 = Process(target=consumer_weather, args=(params, logger_))
