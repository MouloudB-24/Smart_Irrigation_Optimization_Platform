...
from data_ingestion.app_satellite.earth_engine_api.kafka_evaprotranspiration import consumer_st_evapotranspiration, produce_st_evapotranspiration
...
def main():
    ...
    log_file = BASE_DIR / "logs" / f"{params["LOGGING_FILE"]}_EVAPOTRANS_{run_time}.log"
    ...
    try:
        ...
        p1 = Process(target=produce_st_evapotranspiration, args=(params, logger_))
        
        # consume a message and store it in a mongodb
        p2 = Process(target=consumer_st_evapotranspiration, args=(params, logger_))
